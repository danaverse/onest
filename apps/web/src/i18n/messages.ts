...
export const MESSAGES: Record<Locale, Record<MessageKey, string>> = {
  en: {
    ...
    buyPawWithXec: 'Buy {atoms} PAW with XEC',
    buyNeedXec: 'You need a little more XEC to buy PAW.',
    buyDone: 'PAW received! You can create the profile now.',
  ...
  vi: {
    ...
    buyPawWithXec: 'Mua {atoms} PAW bằng XEC',
    buyNeedXec: 'Bạn cần thêm một ít XEC để mua PAW.',
    buyDone: 'Đã nhận PAW! Bây giờ bạn có thể tạo hồ sơ.',
  ...
  zh: {
    ...
    buyPawWithXec: '用 XEC 购买 {atoms} PAW',
    buyNeedXec: '需要更多 XEC 来购买 PAW。',
    buyDone: '已收到 PAW！现在可以创建档案了。',
