...
export const MESSAGES: Record<Locale, Record<MessageKey, string>> = {
  en: {
    brand: 'Onest',
    tagline: 'Eternal animal memories & paw-print tributes',
    ...
    tributeSuccess: 'Paw print dedicated forever!',
  ...
  vi: {
    brand: 'Onest',
    tagline: 'Ký ức vĩnh cửu & dấu chân yêu thương cho thú cưng',
    ...
    tributeSuccess: 'Dấu chân yêu thương đã được ghi lại vĩnh cửu!',
